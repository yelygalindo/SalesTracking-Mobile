...
import 'package:urbantrack/data/repositories/remote_project_repository.dart';
import 'package:urbantrack/data/services/project_service.dart';

void main() {
  test('assigns a project reminder to the authenticated user', () async {
    Map<String, dynamic>? payload;
    final repository = RemoteProjectRepository(
      ProjectService(
