...
2. Publicar `/.well-known/assetlinks.json` en el dominio con el certificado SHA-256 de la firma Android de producción.
3. Publicar `/.well-known/apple-app-site-association` con el Apple Team ID y `io.urbantrack.app`.
